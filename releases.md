...
_Last updated: 2023-06-15_

## Jun, 2023

- Release of [MIC Web](https://mic-web.readthedocs.io/en/latest/): The Model Insertion web (MIC web) is an application to assist scientists in encapsulating their softwares
- Release of [MINT UI 7.1.0](https://github.com/mintproject/mint-ui-lit/releases/tag/7.1.0):
  ...
  - More changes can be found in the [CHANGELOG](https://github.com/mintproject/mint-ui-lit/releases/tag/7.1.0)
- [Model Catalog 1.8.1](https://github.com/mintproject/model-catalog-fastapi/releases/tag/1.8.1): FastAPI migration to improve performance and stability
- [MINT Installation for Kubernetes](https://mintproject.readthedocs.i:o/en/latest/admin-guide/installation/): MINT can be easily deployed on large Kubernetes clusters using Helm. Useful for production instances.
- [Ensemble Manager 4.1.0](https://github.com/mintproject/mint-ensemble-manager/releases/tag/4.1.0)
